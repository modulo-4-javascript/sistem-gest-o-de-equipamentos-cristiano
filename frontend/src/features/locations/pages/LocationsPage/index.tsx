...
export function LocationsPage() {
  ...
  // Debounce da busca: só atualizamos debouncedSearchText 400ms depois da última tecla.
  useEffect(() => {
  ...
  // Alterar situação é uma ação menor, por isso usa um modal separado do formulário completo.
  ...
  return (
    <AppLayout currentPage="Localizações">
      <Container>
        ...
        {/* Cards com totais vindos de GET /locations/summary. */}
        ...
        {/* Modal compartilhado para criar e editar local. */}
        <LocationFormModal
